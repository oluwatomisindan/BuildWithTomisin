...
async function render(node) {
    let render$1;
    try {
        ({ render: render$1 } = await __turbopack_context__.A("[project]/node_modules/@react-email/render/dist/node/index.mjs [app-rsc] (ecmascript, async loader)"));
    } catch  {
    ...
    async performCreate(payload) {
        if (payload.react) {
            if (!this.renderAsync) try {
                const { renderAsync } = await __turbopack_context__.A("[project]/node_modules/@react-email/render/dist/node/index.mjs [app-rsc] (ecmascript, async loader)");
...
//# sourceMappingURL=node_modules_337b622f._.js.map